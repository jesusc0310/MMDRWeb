<%-- 
    Document   : remindPassPage
    Created on : 18 sept. 2020, 13:14:31
    Author     : Jesus Cruz
--%>
...
<html>
    <head>
        <title>Verificación | Mis Marcas de Running</title>
        <meta charset="utf-8">
            ...
            <section id="main" class="container">
                <section class="box special">
                    ...
                    <div class="col-12-mobilep">
                        <h2 class="major">VERIFICATE</h2>
                    </div>
                    <div>
                        <p>Te hemos enviado un correo, por favor, revisa tu bandeja de entrada y verifica que la cuenta te pertenece.</p>
                        <p>Si no te ha llegado ningún correo te lo mandaremos de nuevo pulsando <a href="sendVerificationPage.jsp">aqui</a></p>
                    </div>
                </section>
            </section>
